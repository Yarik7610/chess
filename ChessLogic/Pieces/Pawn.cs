namespace ChessLogic
{
    ...
    {
        public override PieceType Type => PieceType.Pawn; //override getter
        ...
        private IEnumerable<Move> ForwardMoves(Position from, Board board)
        {
            ...
            if (CanMoveTo(oneMovePos, board))
            {
                ...
                if (!HasMoved && CanMoveTo(twoMovesPos, board)) yield return new DoublePawn(from, twoMovesPos);
            }
        }
        ...
        {
            if (forward == Direction.North) forward = Direction.South;
            else forward = Direction.North;
        }
    }
}
